...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('challenge_matrix_values', function (Blueprint $table) {
            ...
            $table->foreignId('row_id')->nullable()->constrained('matrix_headers')->onDelete('cascade');
            $table->foreignId('column_id')->nullable()->constrained('matrix_headers')->onDelete('cascade');
