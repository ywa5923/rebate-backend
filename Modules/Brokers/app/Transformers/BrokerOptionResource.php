...
class BrokerOptionResource extends JsonResource
{
    ...
    public static function getTableColumnsMapping(): array
    {
        ...
        return [
            'id' => ['label' => 'ID', 'visible' => false, 'sortable' => true, 'filterable' => false],
            ...
            'data_type' => ['label' => 'Data Type', 'visible' => true, 'sortable' => true, 'filterable' => true],
            'form_type' => ['label' => 'Form Type', 'visible' => true, 'sortable' => true, 'filterable' => true],
            'meta_data' => ['label' => 'Meta Data', 'visible' => true, 'sortable' => false, 'filterable' => true],
            'for_crypto' => ['label' => 'For Crypto', 'visible' => false, 'sortable' => true, 'filterable' => true],
            'for_brokers' => ['label' => 'For Brokers', 'visible' => false, 'sortable' => true, 'filterable' => true],
            'for_props' => ['label' => 'For Props', 'visible' => false, 'sortable' => true, 'filterable' => true],
            'category_name' => ['label' => 'Category', 'visible' => false, 'sortable' => true, 'filterable' => true],
            ...
            'required' => ['label' => 'Required', 'visible' => true, 'sortable' => true, 'filterable' => true],
            'placeholder' => ['label' => 'Placeholder', 'visible' => true, 'sortable' => false, 'filterable' => true],
            'tooltip' => ['label' => 'Tooltip', 'visible' => true, 'sortable' => false, 'filterable' => true],
            ...
            'default_loading_position' => ['label' => 'Default Loading Position', 'visible' => true, 'sortable' => true, 'filterable' => true],
